  ...
  return (
    ...
    >
      <div className="relative w-full max-w-2xl bg-white dark:bg-[#0C0C0D] border border-black/[0.08] dark:border-white/[0.1] rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[var(--text-secondary)]">
                Technical overview of the SynCine synchronization engine
              </p>
            </div>
          </div>
          <button
        ...
        {/* Section Tabs */}
        <div className="flex px-6 pt-3 border-b border-black/[0.06] dark:border-white/[0.06] gap-2 shrink-0 overflow-x-auto text-xs">
          {[
